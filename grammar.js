module.exports = grammar({
  ...
  rules: {
    ...
    _bgn_imp_doc: ($) =>
      choice($._exp_doc_tal, $._r_blk_seq_r_val, $._r_blk_map_r_val),
    ...
    _br_blk_seq_val: ($) =>
      choice($._br_blk_seq, seq($._br_prp, $._br_blk_seq)),
    ...
    _br_blk_seq_itm: ($) =>
      seq($._br_blk_seq_bgn, optional($._blk_seq_itm_tal)),
    ...
    _br_blk_map_val: ($) =>
      choice($._br_blk_map, seq($._br_prp, $._br_blk_map)),
    ...
    _r_blk_key_itm: ($) =>
      seq($._r_blk_key_bgn, optional(field("key", $._blk_exp_itm_tal))),
    _br_blk_key_itm: ($) =>
      seq($._br_blk_key_bgn, optional(field("key", $._blk_exp_itm_tal))),
    _b_blk_key_itm: ($) =>
      seq($._b_blk_key_bgn, optional(field("key", $._blk_exp_itm_tal))),

    _r_blk_val_itm: ($) =>
      seq($._r_blk_val_bgn, optional(field("value", $._blk_exp_itm_tal))),
    _br_blk_val_itm: ($) =>
      seq($._br_blk_val_bgn, optional(field("value", $._blk_exp_itm_tal))),
    _b_blk_val_itm: ($) =>
      seq($._b_blk_val_bgn, optional(field("value", $._blk_exp_itm_tal))),

    _r_blk_imp_itm: ($) =>
      seq(field("key", $._r_sgl_flw_val_blk), $._blk_imp_itm_tal),
    _br_blk_imp_itm: ($) =>
      seq(field("key", $._br_sgl_flw_val_blk), $._blk_imp_itm_tal),
    _b_blk_imp_itm: ($) =>
      seq(field("key", $._b_sgl_flw_val_blk), $._blk_imp_itm_tal),
    ...
    _r_blk_str_val: ($) =>
      choice($._r_blk_str, seq($._r_prp, choice($._r_blk_str, $._br_blk_str))),
    _br_blk_str_val: ($) =>
      choice(
        $._br_blk_str,
    ...
    _r_sgl_flw_val_blk: ($) =>
      choice($._r_sgl_flw_jsl_val, $._r_sgl_flw_njl_val_blk),
    _br_sgl_flw_val_blk: ($) =>
      choice($._br_sgl_flw_jsl_val, $._br_sgl_flw_njl_val_blk),
    _b_sgl_flw_val_blk: ($) =>
      choice($._b_sgl_flw_jsl_val, $._b_sgl_flw_njl_val_blk),
    ...
    _r_sgl_flw_val_flw: ($) =>
      choice($._r_sgl_flw_jsl_val, $._r_sgl_flw_njl_val_flw),
    ...
    _r_flw_njl_val_blk: ($) =>
      choice($._r_als_val, $._r_prp_val, $._r_pln_blk_val),
    _br_flw_njl_val_blk: ($) =>
      choice($._br_als_val, $._br_prp_val, $._br_pln_blk_val),

    _r_sgl_flw_njl_val_blk: ($) =>
      choice($._r_als_val, $._r_sgl_prp_val, $._r_sgl_pln_blk_val),
    _br_sgl_flw_njl_val_blk: ($) =>
      choice($._br_als_val, $._br_sgl_prp_val, $._br_sgl_pln_blk_val),
    _b_sgl_flw_njl_val_blk: ($) =>
      choice($._b_als_val, $._b_sgl_prp_val, $._b_sgl_pln_blk_val),

    // non-json-like flow value in flow

    _r_flw_njl_val_flw: ($) =>
      choice($._r_als_val, $._r_prp_val, $._r_pln_flw_val),
    _br_flw_njl_val_flw: ($) =>
      choice($._br_als_val, $._br_prp_val, $._br_pln_flw_val),

    _r_sgl_flw_njl_val_flw: ($) =>
      choice($._r_als_val, $._r_sgl_prp_val, $._r_sgl_pln_flw_val),
    ...
    _flw_seq_tal: ($) =>
      seq(
        ...
        choice($._r_flw_seq_end, $._br_flw_seq_end)
      ),
    _sgl_flw_seq_tal: ($) =>
    ...
    _flw_map_tal: ($) =>
      seq(
        ...
        choice($._r_flw_map_end, $._br_flw_map_end)
      ),
    _sgl_flw_map_tal: ($) =>
    ...
    _br_flw_jsl_ann_par: ($) =>
      seq($._br_flw_jsv_bgn, optional(field("value", $._flw_ann_par_tal))),

    _r_sgl_flw_jsl_ann_par: ($) =>
      seq($._r_flw_jsv_bgn, optional(field("value", $._sgl_flw_ann_par_tal))),

    _r_flw_njl_ann_par: ($) =>
      seq($._r_flw_njv_bgn, optional(field("value", $._flw_ann_par_tal))),
    _br_flw_njl_ann_par: ($) =>
      seq($._br_flw_njv_bgn, optional(field("value", $._flw_ann_par_tal))),

    _r_sgl_flw_njl_ann_par: ($) =>
      seq($._r_flw_njv_bgn, optional(field("value", $._sgl_flw_ann_par_tal))),
    ...
    _r_pln_blk_val: ($) =>
      choice($._r_pln_blk, seq($._r_prp, choice($._r_pln_blk, $._br_pln_blk))),
    _br_pln_blk_val: ($) =>
      choice(
        $._br_pln_blk,
        seq($._br_prp, choice($._r_pln_blk, $._br_pln_blk))
      ),

    _r_sgl_pln_blk_val: ($) =>
      choice($._r_sgl_pln_blk, seq($._r_sgl_prp, $._r_sgl_pln_blk)),
    _br_sgl_pln_blk_val: ($) =>
      choice($._br_sgl_pln_blk, seq($._br_sgl_prp, $._r_sgl_pln_blk)),
    _b_sgl_pln_blk_val: ($) =>
      choice($._b_sgl_pln_blk, seq($._b_sgl_prp, $._r_sgl_pln_blk)),
    ...
    _r_pln_flw_val: ($) =>
      choice($._r_pln_flw, seq($._r_prp, choice($._r_pln_flw, $._br_pln_flw))),
    _br_pln_flw_val: ($) =>
      choice(
        $._br_pln_flw,
        seq($._br_prp, choice($._r_pln_flw, $._br_pln_flw))
      ),

    _r_sgl_pln_flw_val: ($) =>
      choice($._r_sgl_pln_flw, seq($._r_sgl_prp, $._r_sgl_pln_flw)),
...
module.exports = global_alias(
  global_alias(module.exports, {
